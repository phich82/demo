    ...
    <div class="container">
        <div class="card grid-box">
            <div class="panel-body">
                <div class="row">
                    <span class="col-md-8" style="font-size: 40px;">マイル積算 - プロモーション</span>
                    <span class="col-md-4 text-right" style="line-height: 40px; height: 40px;">
                        <a href="{{ route('admin.mile.index') }}"><< マイル積算トップへ戻る</a>
                    </span>
                </div>
            </div>
            <div class="panel-body">
                <div class="container">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            {{-- form new promotion --}}
                            <form method="post" action="{{ route('admin.mile.promotion.store') }}" data-back="{{ route('admin.mile.index') }}" id="frm">
                                @csrf
                                <input type="hidden" name="mile_type" value="{{ Constant::MILE_ACCUMULATION }}" />
                                    ...
                                    <div class="col-md-10" style="height: 100%; line-height: 100%;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12" style="height: 42px; line-height: 42px;">
                                                ...
                                                <span class="plusMile" style="display: none;">マイルプラス</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="currentSetting" style="margin-top: 20px;">
                                                @if (!empty($currentSetting))
                                                    <label>現在の基礎設定：{{ $currentSetting->amount }}円＝1マイル</label>
                                                @endif
                                            </div>
                                        </div>
